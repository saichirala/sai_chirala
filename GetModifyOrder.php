        ...
        <TR>
          <TD vAlign=top>
            ...
            <TABLE cellSpacing=0 cellPadding=0 width=600 border=0>
              ...
              <TR>
                <TD class=text>
                  <P align=center>Enter the Order Number of Existing Order</P></TD></TR></TBODY></TABLE>
            <TABLE cellSpacing=0 cellPadding=0 width=600 border=0>
              <TBODY>
              <TR>
                <TD>
              ...
              <TR>
                <TD>
                  <P>&nbsp;</P></TD></TR>
              <TR>
                <TD vAlign=top align=right><B class=text>Enter Order Number : 
                  &nbsp;&nbsp;&nbsp;</B></TD>
                <TD>
                  <FORM name=GetOrderNumber method="post" Action="ModifyOrder.php">
			<INPUT type=text name="OrderNo"></TD></TR>
              <TR>
                ...
                <TD>
                  <P>&nbsp;</P></TD></TR>
            <? if (isset($_SESSION[invalidOrder]))
			echo "<br>Invalid Order number.Enter Again<br>";unset($_SESSION[invalidOrder]);
?>
              <TR>
                <TD>
                  <P>&nbsp;</P></TD>
              ...
              <TR>
                ...
                <TD align=left>
                 ...
                 <INPUT type=submit value=Modify name=submit></FORM></TD></TR></TBODY></TABLE>
            <P>&nbsp;</P>
            <P>&nbsp;</P>
            <P>&nbsp;</P>
            <P><BR>
